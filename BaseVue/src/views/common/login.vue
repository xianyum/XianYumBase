...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      qqLogin () {
        window.location.replace('https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=101831000&redirect_uri=https%3a%2f%2fbase.xianyum.cn%2f%23%2fcheckQQLogin')
      },
      // 用户名 密码登录
      handleLogin () {
        this.$refs.verify.show()
