...
public class RedisUtils {
     ...
     * @return
     */
    public boolean setMin(String key, Object value, Integer minutes) {
        try {
            if (minutes > 0) {
    ...
    public <HK, HV> Object hGetAll(String key) {
        Map<HK, HV> entries = redisTemplate.opsForHash().entries(key);
        return entries;
    }
