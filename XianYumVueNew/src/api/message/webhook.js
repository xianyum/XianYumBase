...
export function getMessageConfigWebhookPage(query) {
  return request({
    url: '/v1/messageConfigWebhook/getPage',
    method: 'get',
    params: query
  })
}
...
export function getMessageConfigWebhookById(id) {
  return request({
    url: '/v1/messageConfigWebhook/getById/' + id,
    method: 'get'
  })
}
...
export function addMessageConfigWebhook(data) {
  return request({
    url: '/v1/messageConfigWebhook/save',
    method: 'post',
    data: data
  })
}
...
export function updateMessageConfigWebhook(data) {
  return request({
    url: '/v1/messageConfigWebhook/update',
    method: 'put',
    data: data
  })
}
...
export function delMessageConfigWebhook(data) {
  return request({
    url: '/v1/messageConfigWebhook/delete',
    method: 'delete',
    data: data
  })
}
...
export function sendWebhook(data) {
  return request({
    url: '/v1/messageConfigWebhook/sendWebhook',
    method: 'put',
    data: data
  })
}
