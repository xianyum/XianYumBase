...
<script>
import { getPage, getById, addTypeConfig, updateTypeConfig, delTypeConfig } from '@/api/message/messageTypeConfig'
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            updateTypeConfig(this.form).then(response => {
              this.$modal.msgSuccess("修改成功");
              this.open = false;
              this.getList();
            });
          } else {
            addTypeConfig(this.form).then(response => {
